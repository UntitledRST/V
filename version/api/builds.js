...
const SOURCES = [
  ...
  { key: 'alpha-app-android', channel: 'alpha', group: 'app-host', platform: 'android', label: 'And',
  ...
  { key: 'beta-app-android', channel: 'beta', group: 'app-host', platform: 'android', label: 'And',
